...
class Rectangle:
    """
        ...
        Класс NegativeSideError будет использоваться, чтобы исключать создание прямоугольников с отрицательными
        сторонами.
        ...
        Методы:
            ...
            __add__(other): Возвращает новый экземпляр прямоугольника, являющийся результатом сложения с
            другим прямоугольником.
            __sub__(other): Возвращает новый экземпляр прямоугольника, являющийся результатом вычитания из
            текущего прямоугольника другого прямоугольника.
